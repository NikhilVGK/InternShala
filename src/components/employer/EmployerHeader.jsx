...
const EmployerHeader = () => {
  ...
  return (
    <div>
      ...
      <div className="employer-header" style={{fontStyle: 'italic'}} >Employer</div>
   ...
   {remove && <div className="employer-btn-container">
      <div className="employer-btn-heading"><button onClick={clickProfile} className='employer-btn' id='employer-user'><PersonRoundedIcon  style={{ fontSize: '100px', backgroundColor: 'red' }}  /></button><div className='employer-heading' >About</div></div>  
      <div className="employer-btn-heading"><button onClick={clickApp} className='employer-btn' id='employer-dash'><GridViewRoundedIcon style={{fontSize:'100px'}}/></button><div className='employer-heading' >Post</div></div>
    </div> } 
    </div>
  )
}
